...
// Real catalog size, kept in sync automatically (see sections.tsx's SERVICE_COUNT).
...
export const FAQS = [
  ...
  { q: "How does discovery actually work?", a: `Connect one or more Gmail inboxes and Zeno reads billing receipts (read-only) to detect recurring charges, or import a statement CSV from any bank. It matches them against a ${SERVICE_COUNT}-service catalog to fill in prices, cycles and cancellation guides.` },
